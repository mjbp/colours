...
/******/ 	var hotCurrentHash = "015ccce5a617967b9016"; // eslint-disable-line no-unused-vars
...
var STORAGE_NAME = 'colours'; //import './polyfills';


var currentColours = void 0;

var colourBlock = function colourBlock(rgb) {
	return '<div class="colours__item" style="background-color:rgb(' + rgb + ')"></div>';
};

var addColour = function addColour(colour) {
	document.querySelector('.js-colours').innerHTML = '' + document.querySelector('.js-colours').innerHTML + colourBlock(colour);
};

var saveColours = function saveColours() {
...
var onDOMContentLoadedTasks = [function () {
	...
	if (currentColours.length) currentColours.forEach(function (colour) {
		addColour(colour);
	});

	document.querySelector('.js-input').addEventListener('submit', function (e) {
		e.preventDefault();
